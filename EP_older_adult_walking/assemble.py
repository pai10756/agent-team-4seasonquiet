...
ELEVENLABS_VOICE_ID = os.environ.get("ELEVENLABS_VOICE_ID", "yC4SQtHeGxfvfsrKVdz9")
...
# ── TTS ─────────────────────────────────────────────────
SPEED_FACTOR = 1.2  # ffmpeg atempo speedup
...
# ── Subtitle rendering: 白色字黑色描邊，略大，無背景條 ──
def render_subtitle_frame(text: str, width: int = CARD_W, font_size: int = 62) -> "numpy.ndarray":
...
def assemble():
    ...
    output_path = base_dir / "older_adult_walking.mp4"
